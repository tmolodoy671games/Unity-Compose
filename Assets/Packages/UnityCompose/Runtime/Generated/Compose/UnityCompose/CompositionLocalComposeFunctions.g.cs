...
public static partial class ComposeFunctions
{
    ...
    [Compiled]
    private static void __CompositionLocalProvider(IImmutableStableList<CompositionLocalProvides> provides, [Composable] Action content, [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
    {
    ...
    [Compiled]
    private static void __CompositionLocalProvider(CompositionLocalProvides provides1, [Composable] Action content, [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
    {
    ...
    [Composable, DontGenerateComposeGroups]
    [Compiled]
    private static void __CompositionLocalProvider(CompositionLocalProvides provides1, CompositionLocalProvides provides2, [Composable] Action content, [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
    {
    ...
    [Composable, DontGenerateComposeGroups]
    [Compiled]
    private static void __CompositionLocalProvider(CompositionLocalProvides provides1, CompositionLocalProvides provides2, CompositionLocalProvides provides3, [Composable] Action content, [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
    {
    ...
    [Composable, DontGenerateComposeGroups]
    [Compiled]
    private static void __CompositionLocalProvider(CompositionLocalProvides provides1, CompositionLocalProvides provides2, CompositionLocalProvides provides3, CompositionLocalProvides provides4, [Composable] Action content, [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
    {
    ...
    [Composable, DontGenerateComposeGroups]
    [Compiled]
    private static void __CompositionLocalProvider(CompositionLocalProvides provides1, CompositionLocalProvides provides2, CompositionLocalProvides provides3, CompositionLocalProvides provides4, CompositionLocalProvides provides5, CompositionLocalProvides provides6, [Composable] Action content, [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
    {
    ...
    [Composable, DontGenerateComposeGroups]
    [Compiled]
    private static void __CompositionLocalProvider(CompositionLocalProvides provides1, CompositionLocalProvides provides2, CompositionLocalProvides provides3, CompositionLocalProvides provides4, CompositionLocalProvides provides5, CompositionLocalProvides provides6, CompositionLocalProvides provides7, [Composable] Action content, [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
    {
    ...
    [Composable, DontGenerateComposeGroups]
    [Compiled]
    private static void __CompositionLocalProvider(CompositionLocalProvides provides1, CompositionLocalProvides provides2, CompositionLocalProvides provides3, CompositionLocalProvides provides4, CompositionLocalProvides provides5, CompositionLocalProvides provides6, CompositionLocalProvides provides7, CompositionLocalProvides provides8, [Composable] Action content, [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
    {
    ...
    [Composable, DontGenerateComposeGroups]
    [Compiled]
    private static void __CompositionLocalProvider(CompositionLocalProvides provides1, CompositionLocalProvides provides2, CompositionLocalProvides provides3, CompositionLocalProvides provides4, CompositionLocalProvides provides5, CompositionLocalProvides provides6, CompositionLocalProvides provides7, CompositionLocalProvides provides8, CompositionLocalProvides provides9, [Composable] Action content, [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
    {
    ...
    [SuppressMessage("ReSharper", "ExplicitCallerInfoArgument")]
    [Compiled]
    private static void __CompositionLocalProviderImpl(IImmutableStableList<CompositionLocalProvides> provides, [Composable] Action content, string filePath, int lineNumber)
    {
