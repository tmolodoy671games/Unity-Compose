...
internal class ComposerImpl : IComposer
{
    public static ComposerImpl? Current { get; private set; }

    private ISlotTableWriter _writer;

    internal ComposerImpl()
    {
    ...
    public CompositionLocalMap RequireCompositionLocalMap() => _writer.GetCompositionLocalMap().NotNull();
