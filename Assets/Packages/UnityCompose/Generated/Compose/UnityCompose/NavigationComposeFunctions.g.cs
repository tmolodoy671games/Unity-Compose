...
public static partial class ComposeFunctions
{
    public static void __Navigation(IComposeCoordinator coordinator, Optional<ContentTransform> transition = default, IModifier? modifier = null, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        if (__isCreated || __isRestarted || __dirty != 0b_01_01_01)
        {
            ...
            __LaunchedEffect(currentBackStack, (!__composer.Changed(currentBackStack) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => Debug.Log(currentBackStack.ToString()))), __composer: __composer, __changed: 0b_00_00);
            ...
            __LaunchedEffect(currentBackStack, (!__composer.ChangedAsStruct((isSwitched, currentBackStack, previousBackStack)) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() =>
            {
                if (!Equals(currentBackStack, previousBackStack.Value))
                    isSwitched.Value = !isSwitched.Value;
            })), __composer: __composer, __changed: 0b_00_00);
            var appearingScreens = (!__composer.ChangedAsStruct<(global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen> currentBackStack, global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen> Value)>((currentBackStack, previousBackStack.Value)) ? __composer.RememberedValue<global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen>>() : __composer.UpdateRememberedValue<global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen>>(currentBackStack.WhereNot(previousBackStack.Value.Contains).ToImmutableStableList()));
            var disappearingScreens = (!__composer.ChangedAsStruct<(global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen> currentBackStack, global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen> Value)>((currentBackStack, previousBackStack.Value)) ? __composer.RememberedValue<global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen>>() : __composer.UpdateRememberedValue<global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen>>(previousBackStack.Value.WhereNot(currentBackStack.Contains).ToImmutableStableList()));
            var allScreens = (!__composer.ChangedAsStruct<(global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen> currentBackStack, global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen> Value)>((currentBackStack, previousBackStack.Value)) ? __composer.RememberedValue<global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen>>() : __composer.UpdateRememberedValue<global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen>>(previousBackStack.Value.Union(currentBackStack).Distinct().OrderBy(static it => it.Priority).ToImmutableStableList()));
            var resolvedTransition = (!__composer.ChangedAsStruct<(global::SharpExtensions.Optional<global::UnityCompose.ContentTransform> transition, global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen> appearingScreens, global::StableCollections.IImmutableStableList<global::UnityCompose.ComposeScreen> disappearingScreens)>((transition, appearingScreens, disappearingScreens)) ? __composer.RememberedValueAsStruct<global::UnityCompose.ContentTransform>() : __composer.UpdateRememberedValueAsStruct<global::UnityCompose.ContentTransform>(ResolveTransition(transition, appearingScreens, disappearingScreens)));
            var progress = __AnimateFloatAsState(targetValue: isSwitched.Value ? 1 : 0f, animationSpec: Tween(easing: LinearEasing, duration: resolvedTransition.TotalDuration), __composer: __composer, __changed: 0b_00_00).Value;
            ...
            __ReusableComposeView<Navigation>(modifier: modifier, content: (!__composer.ChangedAsStruct((coordinator, coordinatorEntry, currentBackStack, resolvedTransition, resolvedProgress, resolvedDuration, screensToRender)) ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
            {
                foreach (var(screen, screenState)in screensToRender)
                {
                    Key(key: screen, content: (!__composer.ChangedAsStruct((coordinator, coordinatorEntry, currentBackStack, resolvedTransition, resolvedProgress, resolvedDuration, screen, screenState)) ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                    {
