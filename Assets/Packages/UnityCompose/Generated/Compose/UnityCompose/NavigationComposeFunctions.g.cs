...
public static partial class ComposeFunctions
{
    ...
    private static void __Navigation(IComposeCoordinator coordinator, Func<ContentTransform>? transition = null, IImmutableStableList<ComposeScreen>? initialScreens = null, Action<float>? onTransitionProgressChanged = null, Action<INavigationScope>? content = null, IModifier? modifier = null)
    {
        ...
        {
            var backStack = !__composer.RememberedKeyChanged<bool>(922712612, true) ? __composer.RememberedValue<UnityCompose.IMutableStateList<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>>() : __composer.UpdateRememberedValue<UnityCompose.IMutableStateList<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>>(MutableStateListOf(initialScreens.OrEmpty().ToImmutableStableList()));
            var coordinatorEntry = LocalCoordinator.Current;
            var parentCoordinator = coordinatorEntry.Coordinator;
            IComposeNavigator navigator = !__composer.RememberedKeyChanged<(UnityCompose.IComposeCoordinator? parentCoordinator, UnityCompose.IMutableStateList<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>> backStack)>(-2126366960, (parentCoordinator, backStack)) ? __composer.RememberedValue<UnityCompose.ComposeNavigatorImpl>() : __composer.UpdateRememberedValue<UnityCompose.ComposeNavigatorImpl>(new ComposeNavigatorImpl(backStack, parentCoordinator));
            DisposableEffect(key: coordinator, effect: !__composer.RememberedKeyChanged<ValueTuple<UnityCompose.IComposeCoordinator, UnityCompose.IComposeNavigator>>(-38242136, (coordinator, navigator)) ? CurrentComposer.RememberedValue<System.Func<UnityCompose.IDisposableEffectScope, System.IDisposable>>() : CurrentComposer.UpdateLambda<System.Func<UnityCompose.IDisposableEffectScope, System.IDisposable>>(it =>
            {
                coordinator.CommandBuffer.SetNavigator(navigator);
                return it.OnDispose(!__composer.RememberedKeyChanged<UnityCompose.IComposeCoordinator>(729466505, coordinator) ? CurrentComposer.RememberedValue<System.Action>() : CurrentComposer.UpdateLambda<System.Action>(() => coordinator.CommandBuffer.RemoveNavigator()));
            }));
            var isSwitched = !__composer.RememberedKeyChanged<bool>(220649216, true) ? __composer.RememberedValue<UnityCompose.IMutableState<bool>>() : __composer.UpdateRememberedValue<UnityCompose.IMutableState<bool>>(MutableStateOf(false));
            var currentBackStack = backStack.GetOrDefault(backStack.Count - 1, IImmutableStableList.Empty<ComposeScreen>());
            var previousBackStack = !__composer.RememberedKeyChanged<bool>(1919553747, true) ? __composer.RememberedValue<StableCollections.IMutableStableProperty<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>>() : __composer.UpdateRememberedValue<StableCollections.IMutableStableProperty<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>>(IMutableStableProperty.Create(initialScreens.OrEmpty().ToImmutableStableList()));
            LaunchedEffect(currentBackStack, !__composer.RememberedKeyChanged<ValueTuple<UnityCompose.IMutableState<bool>?, StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>?, StableCollections.IMutableStableProperty<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>?>>(-1247921522, (isSwitched, currentBackStack, previousBackStack)) ? CurrentComposer.RememberedValue<System.Action>() : CurrentComposer.UpdateLambda<System.Action>(() =>
            {
                if (!Equals(currentBackStack, previousBackStack.Value))
                    isSwitched.Value = !isSwitched.Value;
            }));
            var appearingScreens = !__composer.RememberedKeyChanged<(StableCollections.IImmutableStableList<UnityCompose.ComposeScreen> currentBackStack, StableCollections.IImmutableStableList<UnityCompose.ComposeScreen> Value)>(-1797118221, (currentBackStack, previousBackStack.Value)) ? __composer.RememberedValue<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>() : __composer.UpdateRememberedValue<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>(currentBackStack.WhereNot(previousBackStack.Value.Contains).ToImmutableStableList());
            var disappearingScreens = !__composer.RememberedKeyChanged<(StableCollections.IImmutableStableList<UnityCompose.ComposeScreen> currentBackStack, StableCollections.IImmutableStableList<UnityCompose.ComposeScreen> Value)>(-954591228, (currentBackStack, previousBackStack.Value)) ? __composer.RememberedValue<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>() : __composer.UpdateRememberedValue<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>(previousBackStack.Value.WhereNot(currentBackStack.Contains).ToImmutableStableList());
            var allScreens = !__composer.RememberedKeyChanged<(StableCollections.IImmutableStableList<UnityCompose.ComposeScreen> currentBackStack, StableCollections.IImmutableStableList<UnityCompose.ComposeScreen> Value)>(-14657440, (currentBackStack, previousBackStack.Value)) ? __composer.RememberedValue<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>() : __composer.UpdateRememberedValue<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>(previousBackStack.Value.Union(currentBackStack).Distinct().OrderBy(static it => it.Priority).ToImmutableStableList());
            var resolvedTransition = !__composer.RememberedKeyChanged<(StableCollections.IImmutableStableList<UnityCompose.ComposeScreen> appearingScreens, StableCollections.IImmutableStableList<UnityCompose.ComposeScreen> disappearingScreens, System.Func<UnityCompose.ContentTransform>? transition)>(1255441251, (appearingScreens, disappearingScreens, transition)) ? __composer.RememberedValue<UnityCompose.ContentTransform>() : __composer.UpdateRememberedValue<UnityCompose.ContentTransform>(ResolveTransition(transition, appearingScreens, disappearingScreens));
            ...
            ReusableComposeView<Navigation>(modifier: modifier, content: !__composer.RememberedKeyChanged<ValueTuple<UnityCompose.IComposeCoordinator, System.Action<float>?, System.Action<UnityCompose.INavigationScope>?, UnityCompose.ComposeFunctions.CoordinatorEntry?, StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>?, StableCollections.IMutableStableProperty<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>>?, StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>?, ValueTuple<StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>?, StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>?, UnityCompose.ContentTransform, float, bool, float>>>(-409793815, (coordinator, onTransitionProgressChanged, content, coordinatorEntry, currentBackStack, previousBackStack, appearingScreens, disappearingScreens, allScreens, resolvedTransition, resolvedProgress, isTransitionFinished, resolvedDuration)) ? CurrentComposer.RememberedValue<UnityCompose.ComposableContent?>() : CurrentComposer.UpdateComposableLambda<UnityCompose.ComposableContent?>(() =>
            {
                LaunchedEffect(resolvedProgress, !__composer.RememberedKeyChanged<ValueTuple<System.Action<float>?, float>>(-444250623, (onTransitionProgressChanged, resolvedProgress)) ? CurrentComposer.RememberedValue<System.Action>() : CurrentComposer.UpdateLambda<System.Action>(() => onTransitionProgressChanged?.Invoke(resolvedProgress)));
                if (IsInPreview)
                    return;
                __composer.StartReplaceGroup(427855032);
                foreach (var screen in allScreens)
                {
                    var screenState = !__composer.RememberedKeyChanged<(UnityCompose.ComposeScreen screen, StableCollections.IImmutableStableList<UnityCompose.ComposeScreen> currentBackStack, StableCollections.IImmutableStableList<UnityCompose.ComposeScreen> Value)>(-885490843, (screen, currentBackStack, previousBackStack.Value)) ? __composer.RememberedValue<UnityCompose.TransitionState>() : __composer.UpdateRememberedValue<UnityCompose.TransitionState>(Switch().Case(appearingScreens.Contains(screen), TransitionState.Entering).Case(disappearingScreens.Contains(screen), TransitionState.Exiting).Default(TransitionState.Idle).Get());
                    ...
                    Key(key: screen, content: !__composer.RememberedKeyChanged<ValueTuple<UnityCompose.IComposeCoordinator, System.Action<UnityCompose.INavigationScope>?, UnityCompose.ComposeFunctions.CoordinatorEntry?, StableCollections.IImmutableStableList<UnityCompose.ComposeScreen>?, UnityCompose.ContentTransform, float, float, ValueTuple<UnityCompose.ComposeScreen?, UnityCompose.TransitionState>>>(1447104697, (coordinator, content, coordinatorEntry, currentBackStack, resolvedTransition, resolvedProgress, resolvedDuration, screen, screenState)) ? CurrentComposer.RememberedValue<System.Action>() : CurrentComposer.UpdateLambda<System.Action>(() =>
                    {
                        ...
                        var scope = !__composer.RememberedKeyChanged<UnityCompose.ComposeScreen>(-504083716, screen) ? __composer.RememberedValue<UnityCompose.NavigationScopeImpl>() : __composer.UpdateRememberedValue<UnityCompose.NavigationScopeImpl>(new NavigationScopeImpl(screen.Content));
                        CompositionLocalProvider(LocalCoordinator.Provides(new CoordinatorEntry(coordinator, coordinatorEntry)), LocalIsActive.Provides(new IsActiveEntry(IsActiveSelf: isCurrentScreen && resolvedProgress.AlmostEquals(1f), Parent: isActive)), LocalModifier.Provides(after: LocalModifier.Current.After.OrEmpty().Then(contentModifier)), LocalTransitionState.Provides(state.State), LocalTransitionProgress.Provides(state.Progress), LocalTransitionAbsoluteProgress.Provides(state.AbsoluteProgress), LocalTransitionAbsoluteTimeElapsed.Provides(state.AbsoluteTimeElapsed), LocalTransitionDuration.Provides(state.Duration), content: !__composer.RememberedKeyChanged<ValueTuple<System.Action<UnityCompose.INavigationScope>?, UnityCompose.NavigationScopeImpl?>>(1232782235, (content, scope)) ? CurrentComposer.RememberedValue<UnityCompose.ComposableContent>() : CurrentComposer.UpdateComposableLambda<UnityCompose.ComposableContent>(() =>
                        {
                            if (content != null)
                            {
