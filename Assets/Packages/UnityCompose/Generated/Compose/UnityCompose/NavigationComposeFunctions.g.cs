...
internal partial class NavigationScopeImpl
{
    ...
    {
        if (CurrentComposer.BeginComposeGroup(-1349311267, true))
            return;
        try
        {
            _content();
        ...
        {
            CurrentComposer.EndComposeGroup(CurrentComposer.HasRememberedValue<bool, Action>(-1349211267, true) ? CurrentComposer.RememberedValue<bool, Action>() : CurrentComposer.WriteComposableLambda<bool, Action>(() => __Content()));
        }
    }
}