...
public static partial class ComposeFunctions
{
    public static void __AnimatedContent<T>(T targetState, Func<IAnimatedContentTransitionScope<T>, ContentTransform> transitionSpec, ComposableContent<T, IModifier> content, Optional<AnimationSpec> sizeAnimationSpec = default, IModifier? modifier = null, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        if (__isCreated || __isRestarted || __dirty != 0b_01_01_01_01_01)
        {
            ...
            __LaunchedEffect(targetState, (!__composer.BuildChanged().Changed<T>(targetState!).Changed<global::StableCollections.IMutableStableProperty<T>>(previousValue!).Changed<global::StableCollections.IMutableStableProperty<T>>(targetValue!).Get() ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() =>
            {
                previousValue.Value = targetValue.Value;
                targetValue.Value = targetState;
            })), __composer: __composer, __changed: (__dirty & 0b_00_11));
            var resolvedTransition = (!__composer.Changed<T>(targetState!) ? __composer.RememberedValue<global::UnityCompose.ContentTransform>() : __composer.UpdateRememberedValue<global::UnityCompose.ContentTransform>(Equals(previousValue.Value, targetState) ? IEnterTransition.Empty().TogetherWith(Hide()) : transitionSpec(new AnimatedContentTransitionScopeImpl<T>(previousValue.Value, targetState))));
            ...
            __ReusableComposeView<AnimatedContent>(modifier: modifier.OrEmpty().Then(containerModifier), content: (!__composer.BuildChanged().Changed<T>(targetState!).Changed<global::UnityCompose.ComposableContent<T, global::UnityCompose.IModifier>>(content!).Changed<global::UnityCompose.IMutableState<bool>>(isSwitched!).Changed<global::StableCollections.IMutableStableProperty<T>>(previousValue!).Changed<global::UnityCompose.ContentTransform>(resolvedTransition!).Changed<float>(resolvedProgress!).Changed<float>(resolvedTimeElapsed!).Changed<global::UnityCompose.IModifier>(contentModifier!).Get() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
            {
                ...
                if (isSwitched.Value || isAnimationRunning)
                {
                    ...
                    __CompositionLocalProvider(LocalTransitionState.Provides(state.State), LocalTransitionProgress.Provides(state.Progress), LocalTransitionAbsoluteProgress.Provides(state.AbsoluteProgress), LocalTransitionAbsoluteTimeElapsed.Provides(state.AbsoluteTimeElapsed), LocalTransitionDuration.Provides(state.Duration), content: (!__composer.BuildChanged().Changed<global::UnityCompose.ComposableContent<T, global::UnityCompose.IModifier>>(content!).Changed<((T Value, global::UnityCompose.IModifier Modifier, global::UnityCompose.TransitionState ContentState) First, (T Value, global::UnityCompose.IModifier Modifier, global::UnityCompose.TransitionState ContentState) Second)>(pair!).Get() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() => content(pair.First.Value, pair.First.Modifier))), __composer: __composer, __changed: 0b_00_00_00_00_00_00);
                ...
                if (!isSwitched.Value || isAnimationRunning)
                {
                    ...
                    __CompositionLocalProvider(LocalTransitionState.Provides(state.State), LocalTransitionProgress.Provides(state.Progress), LocalTransitionAbsoluteProgress.Provides(state.AbsoluteProgress), LocalTransitionAbsoluteTimeElapsed.Provides(state.AbsoluteTimeElapsed), LocalTransitionDuration.Provides(state.Duration), content: (!__composer.BuildChanged().Changed<global::UnityCompose.ComposableContent<T, global::UnityCompose.IModifier>>(content!).Changed<((T Value, global::UnityCompose.IModifier Modifier, global::UnityCompose.TransitionState ContentState) First, (T Value, global::UnityCompose.IModifier Modifier, global::UnityCompose.TransitionState ContentState) Second)>(pair!).Get() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() => content(pair.Second.Value, pair.Second.Modifier))), __composer: __composer, __changed: 0b_00_00_00_00_00_00);
