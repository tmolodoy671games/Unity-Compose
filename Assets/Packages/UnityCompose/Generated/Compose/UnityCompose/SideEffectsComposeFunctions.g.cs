...
{
    public static void __SideEffect<TKey>(TKey key, Action block, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        __dirty = 0b_01_01;
        __composer.EndRestartGroup(344620497, __isRestarted)?.UpdateScope(() => __SideEffect(__key, __block, __composer, __composer.UpdateChangedFlags(__changed)));
    }
    ...
    public static void __LaunchedEffect<TKey>(TKey key, Func<IEnumerator> coroutine, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        var __isCreated = __composer.StartRestartGroup(1686445963);
        var __dirty = __changed;
        if ((__changed & 0b_00_11) == 0)
            __dirty |= __composer.Changed(key) ? 0b_00_10 : 0b_00_01;
        if ((__changed & 0b_11_00) == 0)
        ...
        __dirty = 0b_01_01;
        __composer.EndRestartGroup(1686445963, __isRestarted)?.UpdateScope(() => __LaunchedEffect(__key, __coroutine, __composer, __composer.UpdateChangedFlags(__changed)));
    }
    ...
    public static void __LaunchedEffect<TKey>(TKey key, TimeSpan delay, Action block, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        __dirty = 0b_01_01_01;
        __composer.EndRestartGroup(996962608, __isRestarted)?.UpdateScope(() => __LaunchedEffect(__key, __delay, __block, __composer, __composer.UpdateChangedFlags(__changed)));
    }
    ...
    {
        var(__key, __delay, __block) = (key, delay, block);
        var __isCreated = __composer.StartRestartGroup(810770224);
        var __dirty = __changed;
        if ((__changed & 0b_00_00_11) == 0)
            __dirty |= __composer.Changed(key) ? 0b_00_00_10 : 0b_00_00_01;
        if ((__changed & 0b_00_11_00) == 0)
        ...
        __dirty = 0b_01_01_01;
        __composer.EndRestartGroup(810770224, __isRestarted)?.UpdateScope(() => __LaunchedEffect(__key, __delay, __block, __composer, __composer.UpdateChangedFlags(__changed)));
    }
    ...
    public static void __DisposableEffect<TKey>(TKey key, Func<IDisposableEffectScope, IDisposableEffectResult> effect, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        var __isCreated = __composer.StartRestartGroup(482185659);
        var __dirty = __changed;
        if ((__changed & 0b_00_11) == 0)
            __dirty |= __composer.Changed(key) ? 0b_00_10 : 0b_00_01;
        if ((__changed & 0b_11_00) == 0)
        ...
        __dirty = 0b_01_01;
        __composer.EndRestartGroup(482185659, __isRestarted)?.UpdateScope(() => __DisposableEffect(__key, __effect, __composer, __composer.UpdateChangedFlags(__changed)));
    }
}