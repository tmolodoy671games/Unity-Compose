...
public static partial class ComposeFunctions
{
    ...
    private static void __AnimatedSize(ComposableContent content, IModifier? modifier = null, Optional<AnimationSpec> animationSpec = default)
    {
        ...
        if (CurrentComposer.BeginComposeGroup(1847834173, (__content, __modifier, __animationSpec)))
            return;
        try
        {
    ...
    private static (IModifier ContainerModifier, IModifier ContentModifier) __AnimateSizeModifiers(AnimationSpec animationSpec, object? key = null)
    {
        ...
        if (!IsInPreview)
        {
            ...
            if (isSizeValid)
            {
                var animatedSize = key != null ? AnimateVector2AsState(key: key, targetValueFactory: CurrentComposer.HasRememberedValue<ValueTuple<UnityCompose.IMutableState<UnityEngine.Vector2>?, UnityCompose.IMutableState<UnityEngine.Vector2>?>, System.Func<UnityEngine.Vector2>>(-541530029, (containerPaddings, contentSize)) ? CurrentComposer.RememberedValue<ValueTuple<UnityCompose.IMutableState<UnityEngine.Vector2>?, UnityCompose.IMutableState<UnityEngine.Vector2>?>, System.Func<UnityEngine.Vector2>>() : CurrentComposer.WriteLambda<ValueTuple<UnityCompose.IMutableState<UnityEngine.Vector2>?, UnityCompose.IMutableState<UnityEngine.Vector2>?>, System.Func<UnityEngine.Vector2>>(() => contentSize.Value + containerPaddings.Value), animationSpec: resolvedAnimationSpec).Value : AnimateVector2AsState(targetValue: contentSize.Value + containerPaddings.Value, animationSpec: resolvedAnimationSpec).Value;
