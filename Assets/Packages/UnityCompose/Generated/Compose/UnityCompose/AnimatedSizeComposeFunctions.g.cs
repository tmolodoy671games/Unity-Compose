...
{
    private static void __AnimatedSize(ComposableContent<IModifier> content, IModifier? modifier = null, Optional<AnimationSpec> animationSpec = default, global::UnityCompose.Composer __composer = null !)
    {
    ...
    {
        __AnimatedSize(content, modifier, animationSpec, CurrentComposer);
    }

    private static (IModifier ContainerModifier, IModifier ContentModifier) __AnimateSizeModifiers(AnimationSpec animationSpec, object? key = null, global::UnityCompose.Composer __composer = null !)
    {
    ...
    {
        return __AnimateSizeModifiers(animationSpec, key, CurrentComposer);
    }
}