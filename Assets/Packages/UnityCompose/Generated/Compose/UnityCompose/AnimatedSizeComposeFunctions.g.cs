...
public static partial class ComposeFunctions
{
    ...
    private static (IModifier ContainerModifier, IModifier ContentModifier) __AnimateSizeModifiers(AnimationSpec animationSpec, object? key = null, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        if (!IsInPreview)
        {
            ...
            if (isSizeValid)
            {
                var animatedSize = key != null ? __composer.WithReplaceGroup(1769952058, () => __AnimateVector2AsState(key: key, targetValueFactory: (!__composer.BuildChanged().Changed<global::UnityCompose.IMutableState<global::UnityEngine.Vector2>>(containerPaddings!).Changed<global::UnityCompose.IMutableState<global::UnityEngine.Vector2>>(contentSize!).Get() ? __composer.RememberedValue<global::System.Func<global::UnityEngine.Vector2>>() : __composer.UpdateRememberedValue<global::System.Func<global::UnityEngine.Vector2>>(() => contentSize.Value + containerPaddings.Value)), animationSpec: animationSpec, __composer: __composer, __changed: ((__dirty & 0b_00_11_00) >> 2) | ((__dirty & 0b_00_00_11) << 4)).Value) : __composer.WithReplaceGroup(1280845612, () => __AnimateVector2AsState(targetValue: contentSize.Value + containerPaddings.Value, animationSpec: animationSpec, __composer: __composer, __changed: ((__dirty & 0b_00_11) << 2)).Value);
