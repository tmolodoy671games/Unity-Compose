...
public static partial class ComposeFunctions
{
        ...
        where T : VisualElement, new()
    {
        ...
        if (__composer.ShouldExecute((__modifier, __initializer, __content)))
        {
            ...
            DisposableEffect((visualElement, parent, index), !__composer.RememberedKeyChanged<ValueTuple<T?, UnityEngine.UIElements.VisualElement?, int>>(943879159, (visualElement, parent, index)) ? CurrentComposer.RememberedValue<System.Func<UnityCompose.IDisposableEffectScope, System.IDisposable>>() : CurrentComposer.UpdateLambda<System.Func<UnityCompose.IDisposableEffectScope, System.IDisposable>>(it =>
            {
                parent.FastReinsert(index, visualElement);
                return it.OnDispose(!__composer.RememberedKeyChanged<ValueTuple<T?, UnityEngine.UIElements.VisualElement?>>(-1936222871, (visualElement, parent)) ? CurrentComposer.RememberedValue<System.Action>() : CurrentComposer.UpdateLambda<System.Action>(() => parent.Remove(visualElement)));
            }));
            ...
            var currentModifier = !__composer.RememberedKeyChanged<bool>(990022061, true) ? __composer.RememberedValue<StableCollections.IMutableStableProperty<UnityCompose.IModifier?>>() : __composer.UpdateRememberedValue<StableCollections.IMutableStableProperty<UnityCompose.IModifier?>>(IMutableStableProperty.Create<IModifier?>(null));
            var currentProperties = !__composer.RememberedKeyChanged<bool>(1896744871, true) ? __composer.RememberedValue<StableCollections.IMutableStableProperty<StableCollections.IStableSet<UnityCompose.ComposeModifiedProperty>>>() : __composer.UpdateRememberedValue<StableCollections.IMutableStableProperty<StableCollections.IStableSet<UnityCompose.ComposeModifiedProperty>>>(IMutableStableProperty.Create<IStableSet<ComposeModifiedProperty>>(IImmutableStableSet.Empty<ComposeModifiedProperty>()));
            var newProperties = IMutableStableSet.Create<ComposeModifiedProperty>();
            resolvedModifier?.Apply(newProperties);
            var propertiesToRevert = currentProperties.Value.Where(!__composer.RememberedKeyChanged<StableCollections.IMutableStableSet<UnityCompose.ComposeModifiedProperty>?>(423139687, newProperties) ? CurrentComposer.RememberedValue<System.Func<UnityCompose.ComposeModifiedProperty, bool>>() : CurrentComposer.UpdateLambda<System.Func<UnityCompose.ComposeModifiedProperty, bool>>(it => !newProperties.Contains(it)));
            ...
            LaunchedEffect(1, !__composer.RememberedKeyChanged<ValueTuple<T?, UnityCompose.IModifier?>>(814754078, (visualElement, resolvedModifier)) ? CurrentComposer.RememberedValue<System.Action>() : CurrentComposer.UpdateLambda<System.Action>(() => resolvedModifier?.Apply(visualElement)));
            resolvedModifier?.Apply(visualElement);
            FireOnGloballyPositionedCallback(visualElement);
            var currentInitializer = !__composer.RememberedKeyChanged<bool>(-1581597383, true) ? __composer.RememberedValue<StableCollections.IMutableStableProperty<System.Action<T>?>>() : __composer.UpdateRememberedValue<StableCollections.IMutableStableProperty<System.Action<T>?>>(IMutableStableProperty.Create<Action<T>?>(null));
            if (initializer != null)
            {
    ...
    private static void __Column(ComposableContent content, IModifier? modifier = null, Alignment.Horizontal horizontalAlignment = Alignment.Horizontal.Left, Alignment.Vertical verticalAlignment = Alignment.Vertical.Top)
    {
        ...
        var __composer = CurrentComposer;
        __composer.StartRestartGroup(1677386593);
        if (__composer.ShouldExecute((__content, __modifier, __horizontalAlignment, __verticalAlignment)))
        {
            ReusableComposeView<Column>(modifier: modifier, initializer: !__composer.RememberedKeyChanged<ValueTuple<UnityCompose.Alignment.Horizontal, UnityCompose.Alignment.Vertical>>(-338934781, (horizontalAlignment, verticalAlignment)) ? CurrentComposer.RememberedValue<System.Action<UnityCompose.Packages.UnityCompose.Runtime.Impl.Views.Column>?>() : CurrentComposer.UpdateLambda<System.Action<UnityCompose.Packages.UnityCompose.Runtime.Impl.Views.Column>?>(it =>
            {
        ...
        __composer.EndRestartGroup(1677386593)?.UpdateScope(() => __Column(__content, __modifier, __horizontalAlignment, __verticalAlignment));
    }
    ...
    private static void __Row(ComposableContent content, IModifier? modifier = null, Alignment.Horizontal horizontalAlignment = Alignment.Horizontal.Left, Alignment.Vertical verticalAlignment = Alignment.Vertical.Top)
    {
        var(__content, __modifier, __horizontalAlignment, __verticalAlignment) = (content, modifier, horizontalAlignment, verticalAlignment);
        var __composer = CurrentComposer;
        __composer.StartRestartGroup(-900335700);
        if (__composer.ShouldExecute((__content, __modifier, __horizontalAlignment, __verticalAlignment)))
        {
            ReusableComposeView<Row>(modifier: modifier, initializer: !__composer.RememberedKeyChanged<ValueTuple<UnityCompose.Alignment.Horizontal, UnityCompose.Alignment.Vertical>>(313050526, (horizontalAlignment, verticalAlignment)) ? CurrentComposer.RememberedValue<System.Action<UnityCompose.Packages.UnityCompose.Runtime.Impl.Views.Row>?>() : CurrentComposer.UpdateLambda<System.Action<UnityCompose.Packages.UnityCompose.Runtime.Impl.Views.Row>?>(it =>
            {
        ...
        __composer.EndRestartGroup(-900335700)?.UpdateScope(() => __Row(__content, __modifier, __horizontalAlignment, __verticalAlignment));
    }
    ...
    private static void __Box(ComposableContent content, IModifier? modifier = null, Alignment.Horizontal horizontalAlignment = Alignment.Horizontal.Left, Alignment.Vertical verticalAlignment = Alignment.Vertical.Top)
    {
        var(__content, __modifier, __horizontalAlignment, __verticalAlignment) = (content, modifier, horizontalAlignment, verticalAlignment);
        var __composer = CurrentComposer;
        __composer.StartRestartGroup(-1145250396);
        if (__composer.ShouldExecute((__content, __modifier, __horizontalAlignment, __verticalAlignment)))
        {
            ReusableComposeView<Box>(modifier: modifier, initializer: !__composer.RememberedKeyChanged<ValueTuple<UnityCompose.Alignment.Horizontal, UnityCompose.Alignment.Vertical>>(2002325027, (horizontalAlignment, verticalAlignment)) ? CurrentComposer.RememberedValue<System.Action<UnityCompose.Packages.UnityCompose.Runtime.Impl.Views.Box>?>() : CurrentComposer.UpdateLambda<System.Action<UnityCompose.Packages.UnityCompose.Runtime.Impl.Views.Box>?>(it =>
            {
                it.style.alignItems = horizontalAlignment.ToAlign();
                it.style.justifyContent = verticalAlignment.ToJustify();
            }), content: content);
        ...
        __composer.EndRestartGroup(-1145250396)?.UpdateScope(() => __Box(__content, __modifier, __horizontalAlignment, __verticalAlignment));
    }
    ...
    private static void __Spacer(IModifier modifier)
    {
        ...
        var __composer = CurrentComposer;
        __composer.StartRestartGroup(1833800786);
        ...
        __composer.EndRestartGroup(1833800786)?.UpdateScope(() => __Spacer(__modifier));
    }
    ...
    private static void __Text(string text, Optional<Color> color = default, Optional<float> fontSize = default, Optional<TextStyle> style = default, Optional<FontStyle> fontStyle = default, Optional<FontWeight> fontWeight = default, bool softWrap = true, TextAlign textAlign = TextAlign.UpperLeft, IModifier? modifier = null)
    {
        ...
        var __composer = CurrentComposer;
        __composer.StartRestartGroup(200455787);
        if (__composer.ShouldExecute((__text, __color, __fontSize, __style, __fontStyle, __fontWeight, __softWrap, __textAlign, __modifier)))
        {
            ...
            ReusableComposeView<Text>(modifier: modifier, initializer: !__composer.RememberedKeyChanged<ValueTuple<string, SharpExtensions.Optional<UnityEngine.Color>, SharpExtensions.Optional<float>, SharpExtensions.Optional<UnityCompose.TextStyle>, SharpExtensions.Optional<UnityCompose.FontStyle>, SharpExtensions.Optional<UnityCompose.FontWeight>, bool, ValueTuple<UnityCompose.TextAlign, SharpExtensions.Optional<UnityEngine.Color>, SharpExtensions.Optional<UnityCompose.TextStyle>>>>(1172765120, (text, color, fontSize, style, fontStyle, fontWeight, softWrap, textAlign, localContentColor, localTextStyle)) ? CurrentComposer.RememberedValue<System.Action<UnityCompose.Packages.UnityCompose.Runtime.Impl.Views.Text>?>() : CurrentComposer.UpdateLambda<System.Action<UnityCompose.Packages.UnityCompose.Runtime.Impl.Views.Text>?>(it =>
            {
                it.text = text;
        ...
        __composer.EndRestartGroup(200455787)?.UpdateScope(() => __Text(__text, __color, __fontSize, __style, __fontStyle, __fontWeight, __softWrap, __textAlign, __modifier));
    }
    ...
    private static void __Image(ComposeImage image, Color? tint = null, IModifier? modifier = null)
    {
        ...
        var __composer = CurrentComposer;
        __composer.StartRestartGroup(1855771869);
        if (__composer.ShouldExecute((__image, __tint, __modifier)))
        {
            ReusableComposeView<Image>(initializer: !__composer.RememberedKeyChanged<ValueTuple<UnityCompose.ComposeImage, UnityEngine.Color?>>(825790395, (image, tint)) ? CurrentComposer.RememberedValue<System.Action<UnityEngine.UIElements.Image>?>() : CurrentComposer.UpdateLambda<System.Action<UnityEngine.UIElements.Image>?>(it =>
            {
        ...
        __composer.EndRestartGroup(1855771869)?.UpdateScope(() => __Image(__image, __tint, __modifier));
    }
}