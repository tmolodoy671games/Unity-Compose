...
public static partial class DesignSystemComposeFunctions
{
    ...
    {
        __DsClickIndication(content, hovered, onHover, onLeave, rippleColor, hoverColor, animationSpec, modifier, CurrentComposer);
    }

    private static void __DsClickIndication(ComposableContent<DsClickIndicationScope> content, Optional<Color> rippleColor = default, Optional<Color> hoverColor = default, Optional<AnimationSpec> animationSpec = default, IModifier? modifier = null, global::UnityCompose.Composer __composer = null !)
    {
    ...
    {
        __DsClickIndication(content, rippleColor, hoverColor, animationSpec, modifier, CurrentComposer);
    }
}