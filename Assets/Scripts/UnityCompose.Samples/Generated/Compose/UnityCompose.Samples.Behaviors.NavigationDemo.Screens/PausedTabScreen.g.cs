...
internal partial class PausedTabScreen
{
    public override void __Content(IModifier modifier, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        {
            __Box(modifier: modifier.OrEmpty().FillMaxSize().Padding(16.Px()), content: (!__composer.Changed(this) ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
            {
