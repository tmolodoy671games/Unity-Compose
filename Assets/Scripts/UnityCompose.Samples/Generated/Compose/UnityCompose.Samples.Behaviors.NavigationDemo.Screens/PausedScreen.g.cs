...
internal partial class PausedScreen
{
    ...
    private static void __Layout(PausedTab tab, IPausedCoordinator pausedCoordinator, Action<PausedTab> onClick, Action onTabContentClick, IModifier? modifier = null, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        {
            __dirty |= __composer.Changed(tab) ? 0b_00_00_00_00_10 : 0b_00_00_00_00_01;
        }
        else
        {
        ...
        {
            __dirty |= __composer.Changed(pausedCoordinator) ? 0b_00_00_00_10_00 : 0b_00_00_00_01_00;
        }
        else
        {
        ...
        if (__isCreated || __isRestarted || __dirty != 0b_01_01_01_01_01)
        {
            ...
            __Column(modifier: modifier.OrEmpty().FillMaxSize(), content: (!__composer.BuildChanged().Changed<global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab>(tab!).Changed<global::UnityCompose.Samples.Behaviors.NavigationDemo.IPausedCoordinator>(pausedCoordinator!).Changed<global::System.Action<global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab>>(onClick!).Changed<global::System.Action>(onTabContentClick!).Changed<global::StableCollections.IMutableStableProperty<global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab>>(previousTab!).Get() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
            {
                ...
                __Navigation(modifier: Modifier.FillMaxSize().OnClick(onTabContentClick), transition: (!__composer.Changed<(global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab Value, global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab tab)>((previousTab.Value, tab)!) ? __composer.RememberedValue<global::UnityCompose.ContentTransform>() : __composer.UpdateRememberedValue<global::UnityCompose.ContentTransform>(ResolveTransform(previousTab.Value, tab))), coordinator: pausedCoordinator, __composer: __composer, __changed: ((__dirty & 0b_00_11_00) >> 2));
    ...
    private static void __TabsRow(PausedTab currentTab, Action<PausedTab> onClick, IModifier? modifier = null, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        {
            __Row(modifier: modifier.OrEmpty().Align(Alignment.CenterHorizontally).Margin(top: 16.Px()), content: (!__composer.BuildChanged().Changed<global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab>(currentTab!).Changed<global::System.Action<global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab>>(onClick!).Get() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
            {
    ...
    private static void __Tab(PausedTab tab, bool selected, Action<PausedTab> onClick, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        if (__isCreated || __isRestarted || __dirty != 0b_01_01_01)
        {
            __DsClickIndication(modifier: Modifier.Background(Color.gray).Padding(horizontal: __AnimateFloatAsState(selected ? 120 : 40, __composer: __composer, __changed: 0b_01_00).Value.Px()).Padding(vertical: 12.Px()).Border(8.Px()).Margin(horizontal: 4.Px()).OnClick((!__composer.BuildChanged().Changed<global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab>(tab!).Changed<global::System.Action<global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab>>(onClick!).Get() ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => onClick(tab)))), content: (!__composer.Changed<global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab>(tab!) ? __composer.RememberedValue<global::UnityCompose.ComposableContent<global::UI.DesignSystem.Compose.DsClickIndicationScope>>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent<global::UI.DesignSystem.Compose.DsClickIndicationScope>>(it =>
            {
