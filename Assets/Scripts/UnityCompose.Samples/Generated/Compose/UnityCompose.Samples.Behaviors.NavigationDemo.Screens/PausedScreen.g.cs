...
internal partial class PausedScreen
{
    public override void __Content(IModifier modifier, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        if (__isCreated || __isRestarted || __dirty != 0b_01)
        {
            ...
            __Layout(tab: currentTab.Value, pausedCoordinator: pausedCoordinator, onClick: (!__composer.ChangedAsStruct((pausedCoordinator, currentTab)) ? __composer.RememberedValue<global::System.Action<global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab>>() : __composer.UpdateRememberedValue<global::System.Action<global::UnityCompose.Samples.Behaviors.NavigationDemo.PausedTab>>(it =>
            {
                currentTab.Value = it;
                pausedCoordinator.ShowTab(it);
            })), onTabContentClick: (!__composer.Changed(coordinator) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => coordinator.ShowResumedScreen())), modifier: modifier, __composer: __composer, __changed: ((__dirty & 0b_00_00_00_00_11) << 8));
        }
        else
        {
    ...
    private static void __Layout(PausedTab tab, IPausedCoordinator pausedCoordinator, Action<PausedTab> onClick, Action onTabContentClick, IModifier? modifier = null, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        {
            __dirty |= __composer.ChangedAsStruct(tab) ? 0b_00_00_00_00_10 : 0b_00_00_00_00_01;
        }
        else
        {
        ...
        if (__isCreated || __isRestarted || __dirty != 0b_01_01_01_01_01)
        {
            ...
            __Column(modifier: modifier.OrEmpty().FillMaxSize(), content: (!__composer.ChangedAsStruct((tab, pausedCoordinator, onClick, onTabContentClick, previousTab)) ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
            {
    ...
    private static void __TabsRow(PausedTab currentTab, Action<PausedTab> onClick, IModifier? modifier = null, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        {
            __dirty |= __composer.ChangedAsStruct(currentTab) ? 0b_00_00_10 : 0b_00_00_01;
        }
        else
        {
        ...
        {
            __Row(modifier: modifier.OrEmpty().Align(Alignment.CenterHorizontally).Margin(top: 16.Px()), content: (!__composer.ChangedAsStruct((currentTab, onClick)) ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
            {
    ...
    private static void __Tab(PausedTab tab, bool selected, Action<PausedTab> onClick, global::UnityCompose.Composer __composer = null !, int __changed = -1)
    {
        ...
        if ((__changed & 0b_00_00_11) == 0)
        {
            __dirty |= __composer.ChangedAsStruct(tab) ? 0b_00_00_10 : 0b_00_00_01;
        }
        else
        {
            __dirtyRestart |= 0b_00_00_01;
        ...
        if ((__changed & 0b_00_11_00) == 0)
        {
            __dirty |= __composer.ChangedAsStruct(selected) ? 0b_00_10_00 : 0b_00_01_00;
        }
        else
        {
            __dirtyRestart |= 0b_00_01_00;
        ...
        if (__isCreated || __isRestarted || __dirty != 0b_01_01_01)
        {
            __DsClickIndication(modifier: Modifier.Background(Color.gray).Padding(horizontal: __AnimateFloatAsState(selected ? 120 : 40, __composer: __composer, __changed: 0b_01_01_00).Value.Px()).Padding(vertical: 12.Px()).Border(8.Px()).Margin(horizontal: 4.Px()).OnClick((!__composer.ChangedAsStruct((tab, onClick)) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => onClick(tab)))), content: (!__composer.ChangedAsStruct(tab) ? __composer.RememberedValue<global::UnityCompose.ComposableContent<global::UI.DesignSystem.Compose.DsClickIndicationScope>>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent<global::UI.DesignSystem.Compose.DsClickIndicationScope>>(it =>
            {
