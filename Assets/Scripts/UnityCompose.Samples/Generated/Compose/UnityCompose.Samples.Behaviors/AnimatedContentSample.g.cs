            ...
            try
            {
                ...
                Box(horizontalAlignment: Alignment.Horizontal.Center, verticalAlignment: Alignment.Vertical.Center, modifier: Modifier.FillMaxSize(), content: RememberComposable<global::System.Action>(Duration, () =>
                {
                    Column(horizontalAlignment: Alignment.Horizontal.Center, modifier: Modifier.Name("animated-content-sample"), content: RememberComposable<global::System.Action>(Duration, () =>
                    {
                        ...
                        AnimatedContent(targetState: isSwitched.Value ? "Looooooooooooooooooong" : "Short", transitionSpec: Remember<global::System.Func<string, string, global::UnityCompose.ContentTransform>>(isSwitched, (_, _) => isSwitched.Value ? ContentTransform(enter: SlideInVertically(it => -it) + FadeIn(), exit: SlideOutVertically(it => it) + FadeOut()) : ContentTransform(enter: SlideInVertically(it => it) + FadeIn(), exit: SlideOutVertically(it => -it) + FadeOut())), animateSize: true, transitionDuration: Duration, modifier: Modifier.Name("animated-content").Background(isSwitched.Value ? Color.green : Color.red, Transition(Duration)), content: RememberComposable<global::System.Action<string>>(null, state =>
                        {
