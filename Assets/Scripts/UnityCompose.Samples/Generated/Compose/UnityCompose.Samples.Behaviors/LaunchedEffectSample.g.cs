...
namespace UnityCompose.Samples.Behaviors
{
    internal partial class LaunchedEffectSample
    {
        ...
        private static void __Layout()
        {
            ...
            try
            {
                Column(alignHorizontally: Align.Center, alignVertically: Justify.Center, style: ComposeStyle.Empty.Name("launched-effect-disposal").FlexGrow(1), content: RememberComposable<global::System.Action>(null, () =>
                {
                    var count = Remember(() => MutableStateOf(0));
                    Label(text: count.Value.ToString(), textColor: Color.white, fontSize: 40, style: ComposeStyle.Empty.Name("test-label").BackgroundColor(Color.red).Padding(10));
