        ...
        private static void __Layout(global::UnityCompose.Composer __composer = null !, int __changed = -1)
        {
            ...
            if (__isCreated || __isRestarted || __changed != 0b_00)
            {
                __Box(alignment: Alignment.Center, modifier: Modifier.FillMaxSize().Background(Color.white), content: (!__composer.Changed() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                {
                    ...
                    __Box(modifier: Modifier.Padding(horizontal: __AnimateFloatAsState(isHovered.Value ? 80 : 40, __composer: __composer, __changed: 0b_01_00).Value.Px(), vertical: 16.Px()).Background(__AnimateColorAsState(isPressed.Value ? Color.darkBlue : Color.blue, __composer: __composer, __changed: 0b_01_00).Value).Border(radius: 16.Px()).OnMouseEnter((!__composer.Changed<global::UnityCompose.IMutableState<bool>>(isHovered!) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => isHovered.Value = true))).OnMouseLeave((!__composer.Changed<global::UnityCompose.IMutableState<bool>>(isHovered!) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => isHovered.Value = false))).OnLmbDown((!__composer.Changed<global::UnityCompose.IMutableState<bool>>(isPressed!) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => isPressed.Value = true))).OnLmbUp((!__composer.Changed<global::UnityCompose.IMutableState<bool>>(isPressed!) ? __composer.RememberedValue<global::System.Action<global::UnityCompose.MouseClickInfo>>() : __composer.UpdateRememberedValue<global::System.Action<global::UnityCompose.MouseClickInfo>>(it =>
                    {
