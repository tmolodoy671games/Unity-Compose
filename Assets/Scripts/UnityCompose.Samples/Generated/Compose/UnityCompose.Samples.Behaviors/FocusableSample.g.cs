    ...
    internal partial class FocusableSample
    {
        ...
        private static void __FocusableItem(string name, bool isDefault = false, global::UnityCompose.Composer __composer = null !, int __changed = -1)
        {
            ...
            if (__isCreated || __isRestarted || __dirty != 0b_01_01)
            {
                ...
                __Spacer(Modifier.Margin(all: 4.Dp()).Size(width: 100.Dp(), height: 40.Dp()).Clip(RoundedCornerShape(16.Dp())).Background(__AnimateColorAsState(isFocused.Value ? Color.lightSeaGreen : Color.indianRed, __composer: __composer, __changed: 0b_01_01_00).Value).Scale(__AnimateFloatAsState(isFocused.Value ? 1.1f : 1f, __composer: __composer, __changed: 0b_01_01_00).Value).Name(name).Focusable().OnFocusChanged((!__composer.Changed<global::UnityCompose.IMutableState<bool>>(isFocused!) ? __composer.RememberedValue<global::System.Action<global::UnityCompose.FocusState>>() : __composer.UpdateRememberedValue<global::System.Action<global::UnityCompose.FocusState>>(it => isFocused.Value = it.IsFocused))).FocusRequester(focusRequester), __composer: __composer, __changed: 0b_00);
            }
            else
            {
                __composer.SkipToGroupEnd();
