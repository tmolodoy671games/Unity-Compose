    ...
    internal partial class FocusableSample
    {
        protected override void __Content(global::UnityCompose.Composer __composer = null !, int __changed = -1)
        {
            ...
            if (__isCreated || __isRestarted || __changed != 0b_00)
            {
                ...
                {
                    __Row(modifier: Modifier.Background(Color.white).Border(16.Px()).Padding(16.Px()), content: (!__composer.Changed() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                    {
        ...
        private static void __FocusableItem(string name, bool isDefault = false, global::UnityCompose.Composer __composer = null !, int __changed = -1)
        {
            ...
            if (__isCreated || __isRestarted || __dirty != 0b_01_01)
            {
                ...
                __Spacer(Modifier.Margin(4.Px()).Size(width: 100.Px(), height: 40.Px()).Border(16.Px()).Background(__AnimateColorAsState(isFocused.Value ? Color.lightSeaGreen : Color.indianRed, __composer: __composer, __changed: 0b_01_01_00).Value).Scale(__AnimateFloatAsState(isFocused.Value ? 1.1f : 1f, __composer: __composer, __changed: 0b_01_01_00).Value).Name(name).Focusable().OnFocusChanged((!__composer.Changed<global::UnityCompose.IMutableState<bool>>(isFocused!) ? __composer.RememberedValue<global::System.Action<global::UnityCompose.FocusState>>() : __composer.UpdateRememberedValue<global::System.Action<global::UnityCompose.FocusState>>(it => isFocused.Value = it.IsFocused))).FocusRequester(focusRequester), __composer: __composer, __changed: 0b_00);
            }
            else
            {
                __composer.SkipToGroupEnd();
