        ...
        private static void __Layout(global::UnityCompose.Composer __composer = null !, int __changed = -1)
        {
            ...
            if (__isCreated || __isRestarted || __changed != 0b_00)
            {
                __Column(horizontalAlignment: Alignment.CenterHorizontally, verticalArrangement: Arrangement.Center, modifier: Modifier.FillMaxSize(), content: (!__composer.Changed() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                {
                    ...
                    __Spacer(Modifier.Size(100.Dp()).Background(Color.red).Border(16.Dp()).OnClick((!__composer.Changed<global::UnityCompose.IMutableState<bool>>(isRedSwitched!) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => isRedSwitched.Value = !isRedSwitched.Value))).Scale(__AnimateFloatAsState(isRedSwitched.Value ? 1.5f : 1f, __composer: __composer, __changed: 0b_01_01_00).Value).Margin(top: 40.Dp()), __composer: __composer, __changed: 0b_00);
                    ...
                    __Spacer(Modifier.Size(100.Dp()).Background(Color.green).Border(16.Dp()).OnClick((!__composer.Changed<global::UnityCompose.IMutableState<bool>>(isGreenSwitched!) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => isGreenSwitched.Value = !isGreenSwitched.Value))).Scale(__AnimateFloatAsState(isGreenSwitched.Value ? 1.5f : 1f, __composer: __composer, __changed: 0b_01_01_00).Value).Margin(top: 40.Dp()), __composer: __composer, __changed: 0b_00);
                    ...
                    __Spacer(Modifier.Size(100.Dp()).Background(Color.blue).Border(16.Dp()).OnClick((!__composer.Changed<global::UnityCompose.IMutableState<bool>>(isBlueSwitched!) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => isBlueSwitched.Value = !isBlueSwitched.Value))).Scale(__AnimateFloatAsState(isBlueSwitched.Value ? 1.5f : 1f, __composer: __composer, __changed: 0b_01_01_00).Value).Margin(top: 40.Dp()), __composer: __composer, __changed: 0b_00);
