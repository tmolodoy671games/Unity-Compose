    ...
    internal partial class ModalMenuSample
    {
        protected override void __Content(global::UnityCompose.Composer __composer = null !, int __changed = -1)
        {
            ...
            if (__isCreated || __isRestarted || __changed != 0b_00)
            {
                ...
                {
                    __Box(modifier: Modifier.Padding(horizontal: 20.Dp(), vertical: 8.Dp()).Background(Color.lightGreen).Blur(__AnimateFloatAsState(LocalModalMenuTags.Current.IsNotEmpty().ToInt(), __composer: __composer, __changed: 0b_01_01_00).Value * 10).OnClick((!__composer.Changed<global::UnityCompose.IMutableState<bool>>(showModalMenu!) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => showModalMenu.Value = true))).Clip(RoundedCornerShape(16.Dp())), content: (!__composer.Changed() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                    {
