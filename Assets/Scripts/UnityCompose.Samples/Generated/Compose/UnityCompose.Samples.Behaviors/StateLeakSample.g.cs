                    ...
                    __Box(alignment: Alignment.Center, modifier: Modifier.FillMaxSize(), content: (!__composer.Changed() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                    {
                        __Column(modifier: Modifier, content: (!__composer.Changed() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                        {
                            ...
                            if (showFirst.Value)
                            {
                                ...
                                __Text(text: $"Clicked {firstCount.Value} times", textAlign: TextAlign.MiddleCenter, modifier: Modifier.FillMaxWidth().Background(Color.red).Padding(all: 20.Dp()).Border(radius: 16.Dp()).OnClick((!__composer.Changed<global::UnityCompose.IMutableState<int>>(firstCount!) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => firstCount.Value++))).Name("first-button"), __composer: __composer, __changed: 0b_01_01_01_01_01_01_01_00);
                            }
                            ...
                            __Text(text: $"Clicked {secondCount.Value} times", textAlign: TextAlign.MiddleCenter, modifier: Modifier.FillMaxWidth().Background(Color.green).Padding(all: 20.Dp()).Border(radius: 16.Dp()).Margin(top: 16.Dp()).OnClick((!__composer.Changed<global::UnityCompose.IMutableState<int>>(secondCount!) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => secondCount.Value++))).Name("second-button"), __composer: __composer, __changed: 0b_01_01_01_01_01_01_01_00);
                            __Text(text: "Switch", textAlign: TextAlign.MiddleCenter, modifier: Modifier.FillMaxWidth().Background(Color.blue).Padding(all: 20.Dp()).Border(radius: 16.Dp()).Margin(top: 16.Dp()).OnClick((!__composer.Changed<global::UnityCompose.IMutableState<bool>>(showFirst!) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => showFirst.Value = !showFirst.Value))).Name("switch-button"), __composer: __composer, __changed: 0b_01_01_01_01_01_01_01_01);
