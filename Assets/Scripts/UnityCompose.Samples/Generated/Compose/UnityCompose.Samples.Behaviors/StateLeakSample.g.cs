    ...
    internal partial class StateLeakSample
    {
        ...
        private static void __Layout()
        {
            ...
            if (__composer.ShouldExecute(true))
            {
                ...
                {
                    Column(modifier: Modifier, content: !__composer.Changed() ? __composer.RememberedValue<UnityCompose.ComposableContent>() : __composer.UpdateComposableLambda<UnityCompose.ComposableContent>(() =>
                    {
