            ...
            try
            {
                Box(alignHorizontally: Align.Center, alignVertically: Justify.Center, style: Modifier.Width(100.Percent()).Height(100.Percent()).FlexGrow(1), content: RememberComposable<global::System.Action>(null, () =>
                {
                    Column(alignHorizontally: Align.Center, style: Modifier.Name("animated-size-sample"), content: RememberComposable<global::System.Action>(null, () =>
                    {
                        ...
                        Label(text: "Switch", textColor: Color.white, fontSize: 64, style: Modifier.Name("switch-button").NewPadding(all: 32).Background(Color.blue).Margin(top: 16).BorderRadius(16).OnClick(Remember<global::System.Action>(isSwitched, () => isSwitched.Value = !isSwitched.Value)));
                    }));
                }));
            }
            finally
