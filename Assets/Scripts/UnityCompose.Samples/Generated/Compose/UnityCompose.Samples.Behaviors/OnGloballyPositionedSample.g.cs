    ...
    internal partial class OnGloballyPositionedSample
    {
        ...
        private static void __Layout(global::UnityCompose.Composer __composer = null !, int __changed = -1)
        {
            ...
            if (__isCreated || __isRestarted || __changed != 0b_00)
            {
                ...
                __Column(horizontalAlignment: Alignment.CenterHorizontally, modifier: Modifier.FillMaxSize().Padding(all: 100.Dp()).OnGloballyPositioned((!__composer.Changed<global::UnityCompose.IMutableState<global::SharpExtensions.Optional<global::UnityCompose.LayoutCoordinates>>>(parentCoordinates!) ? __composer.RememberedValue<global::System.Action<global::UnityCompose.LayoutCoordinates>>() : __composer.UpdateRememberedValue<global::System.Action<global::UnityCompose.LayoutCoordinates>>(it => parentCoordinates.Value = it))), content: (!__composer.Changed<global::UnityCompose.IMutableState<global::SharpExtensions.Optional<global::UnityCompose.LayoutCoordinates>>>(parentCoordinates!) ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                {
                    ...
                    __Box(modifier: Modifier.FillMaxSize(), content: (!__composer.BuildChanged().Changed<global::UnityCompose.IMutableState<bool>>(isSwitched!).Changed<global::UnityCompose.IMutableState<global::SharpExtensions.Optional<global::UnityEngine.Vector2>>>(layout!).Get() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                    {
                        var transitionSpec = Tween();
                        __Box(alignment: Alignment.Center, modifier: Modifier.Size(40.Dp()).Background(Color.blue).Offset(x: __AnimateFloatAsState(targetValue: 500 * isSwitched.Value.ToInt(), animationSpec: transitionSpec, __composer: __composer, __changed: 0b_01_00_00).Value.Dp()), content: (!__composer.Changed<global::UnityCompose.IMutableState<global::SharpExtensions.Optional<global::UnityEngine.Vector2>>>(layout!) ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                        {
                            __Box((!__composer.Changed<global::UnityCompose.IMutableState<global::SharpExtensions.Optional<global::UnityEngine.Vector2>>>(layout!) ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                            {
                                __Box((!__composer.Changed<global::UnityCompose.IMutableState<global::SharpExtensions.Optional<global::UnityEngine.Vector2>>>(layout!) ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                                {
                                    __Spacer(Modifier.Background(Color.green).Size(20.Dp()).OnGloballyPositioned((!__composer.Changed<global::UnityCompose.IMutableState<global::SharpExtensions.Optional<global::UnityEngine.Vector2>>>(layout!) ? __composer.RememberedValue<global::System.Action<global::UnityCompose.LayoutCoordinates>>() : __composer.UpdateRememberedValue<global::System.Action<global::UnityCompose.LayoutCoordinates>>(it => layout.Value = it.GlobalCenter))), __composer: __composer, __changed: 0b_00);
                    ...
                    if (layout.Value.HasValue && parentCoordinates.Value.HasValue)
                    {
                        ...
                        __Spacer(modifier: Modifier.Size(10.Dp()).Background(Color.red).Float().Position(left: parentCoordinatesValue.GlobalToLocal(layout.Value.Value).x.Dp(), top: parentCoordinatesValue.GlobalToLocal(layout.Value.Value).y.Dp()), __composer: __composer, __changed: 0b_00);
                    }
