            ...
            if (__isCreated || __isRestarted || __changed != 0b_00)
            {
                __Column(horizontalAlignment: Alignment.CenterHorizontally, verticalArrangement: Arrangement.Center, modifier: Modifier.FillMaxSize(), content: (!__composer.Changed() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                {
                    ...
                    if (showMovingSquare.Value)
                    {
                        ...
                        __Box((!__composer.ChangedAsStruct((isSwitched, offset)) ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() => __Box((!__composer.ChangedAsStruct((isSwitched, offset)) ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() => __Spacer(Modifier.Size(100.Px()).Background(Color.green).Offset(offset.Px()).OnClick((!__composer.Changed(isSwitched) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => isSwitched.Value = !isSwitched.Value))), __composer: __composer, __changed: 0b_00))), __composer: __composer, __changed: 0b_01_01_00))), __composer: __composer, __changed: 0b_01_01_00);
                    }
                    ...
                    __Text(text: "Switch", color: Color.white, fontSize: 32, modifier: Modifier.Background(Color.blue).Padding(horizontal: 32.Px() + 32 * __AnimateFloatAsState(isHovered.Value.ToInt(), __composer: __composer, __changed: 0b_01_01_00).Value.Px(), vertical: 16.Px()).Border(16.Px()).Margin(top: 32.Px()).OnClick((!__composer.Changed(showMovingSquare) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => showMovingSquare.Value = !showMovingSquare.Value))).OnMouseEnter((!__composer.Changed(isHovered) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => isHovered.Value = true))).OnMouseLeave((!__composer.Changed(isHovered) ? __composer.RememberedValue<global::System.Action>() : __composer.UpdateRememberedValue<global::System.Action>(() => isHovered.Value = false))), __composer: __composer, __changed: 0b_01_01_01_01_01_01_00_01);
