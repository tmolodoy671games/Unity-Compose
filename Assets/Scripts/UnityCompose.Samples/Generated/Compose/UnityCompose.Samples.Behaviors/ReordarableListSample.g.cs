    ...
    internal partial class ReordarableListSample
    {
        ...
        private static void __Item(int state, Action onMoveUpClick, Action onMoveDownClick, Action onRemoveClick, global::UnityCompose.Composer __composer = null !, int __changed = -1)
        {
            ...
            if (__isCreated || __isRestarted || __dirty != 0b_01_01_01_01)
            {
                ...
                __Row(verticalAlignment: Alignment.CenterVertically, modifier: Modifier.Name("item-row").Background(Color.cyan).FillMaxWidth().Padding(all: 4.Px()).Border(radius: 12.Px()).Margin(vertical: 4.Px()), content: (!__composer.BuildChanged().Changed<int>(state!).Changed<global::System.Action>(onMoveUpClick!).Changed<global::System.Action>(onMoveDownClick!).Changed<global::System.Action>(onRemoveClick!).Get() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                {
                    ...
                    __Column(content: (!__composer.BuildChanged().Changed<global::System.Action>(onMoveUpClick!).Changed<global::System.Action>(onMoveDownClick!).Get() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                    {
