    ...
    internal partial class ReordarableListSample
    {
        ...
        private static void __Layout()
        {
            ...
            try
            {
                ...
                {
                    Column(horizontalAlignment: Alignment.Horizontal.Center, modifier: Modifier.Name("reordarable-list-sample").NewPadding(top: 100).FillMaxHeight().Width(800), content: RememberComposable<global::System.Action<global::UnityCompose.IColumnScope>>(null, scope =>
                    {
                        var items = Remember(() => MutableStateListOf(1, 2));
                        Text(text: "Add Item", textColor: Color.white, fontSize: 40, modifier: Modifier.Name("add-item-button").Then(scope.Align(Alignment.Horizontal.Right)).Background(Color.blue).NewPadding(horizontal: 32, vertical: 16).Border(radius: 16).OnClick(Remember<global::System.Action>(items, () =>
                        {
