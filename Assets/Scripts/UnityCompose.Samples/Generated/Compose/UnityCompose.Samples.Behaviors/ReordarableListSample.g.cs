...
namespace UnityCompose.Samples.Behaviors
{
    internal partial class ReordarableListSample
    {
        ...
        {
            var __isCreated = __composer.StartRestartGroup(2080562580);
            var __isRestarted = __composer.IsRestarted();
            if (__isCreated || __isRestarted || __changed != 0b_00)
            {
                __Box(alignment: Alignment.Center, modifier: Modifier, content: (!__composer.Changed() ? __composer.RememberedValue<UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<UnityCompose.ComposableContent>(() =>
                {
                    __Column(horizontalAlignment: Alignment.CenterHorizontally, modifier: Modifier.Name("reordarable-list-sample").Padding(top: 100.Px()).FillMaxHeight().Width(800.Px()), content: (!__composer.Changed() ? __composer.RememberedValue<UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<UnityCompose.ComposableContent>(() =>
                    {
                        ...
                        __Column(horizontalAlignment: Alignment.CenterHorizontally, modifier: Modifier.Name("nested-column").FillMaxWidth(), content: (!__composer.ChangedAsStruct((items, immutableItems)) ? __composer.RememberedValue<UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<UnityCompose.ComposableContent>(() =>
                        {
                            ...
                            foreach (var item in immutableItems)
                            {
                                ...
                                {
                                    __Item(state: item, onMoveUpClick: (!__composer.ChangedAsStruct((items, item)) ? __composer.RememberedValue<System.Action>() : __composer.UpdateRememberedValue<System.Action>(() =>
                                    {
            ...
            __composer.EndRestartGroup(2080562580, __isRestarted)?.UpdateScope(() => __Layout(__composer, 0));
        }
        ...
        private static void __Item(int state, Action onMoveUpClick, Action onMoveDownClick, Action onRemoveClick, global::UnityCompose.Composer __composer = null !, int __changed = -1)
        {
            ...
            var __isCreated = __composer.StartRestartGroup(2014500465);
            ...
            if (__isCreated || __isRestarted || __dirty != 0b_01_01_01_01)
            {
                ...
                __Row(verticalAlignment: Alignment.CenterVertically, modifier: Modifier.Name("item-row").Background(Color.cyan).FillMaxWidth().Padding(all: 4.Px()).Border(radius: 12.Px()).Margin(vertical: 4.Px()), content: (!__composer.ChangedAsStruct((state, onMoveUpClick, onMoveDownClick, onRemoveClick)) ? __composer.RememberedValue<UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<UnityCompose.ComposableContent>(() =>
                {
                    ...
                    __Text(text: counter.Value.ToString(), color: Color.white, fontSize: 40, modifier: Modifier.Background(Color.green).Padding(horizontal: 16.Px()).Border(12.Px()).OnClick((!__composer.Changed(counter) ? __composer.RememberedValue<System.Action>() : __composer.UpdateRememberedValue<System.Action>(() => counter.Value++))), __composer: __composer, __changed: 0b_01_01_01_01_01_01_00_00);
                    __Column(content: (!__composer.ChangedAsStruct((onMoveUpClick, onMoveDownClick)) ? __composer.RememberedValue<UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<UnityCompose.ComposableContent>(() =>
                    {
            ...
            __composer.EndRestartGroup(2014500465, __isRestarted)?.UpdateScope(() => __Item(__state, __onMoveUpClick, __onMoveDownClick, __onRemoveClick, __composer, __dirtyRestart));
        }

        private static void __Item(int state, Action onMoveUpClick, Action onMoveDownClick, Action onRemoveClick)
        {
            __Item(state, onMoveUpClick, onMoveDownClick, onRemoveClick, CurrentComposer, 0b_10101010);
        }
    }
}