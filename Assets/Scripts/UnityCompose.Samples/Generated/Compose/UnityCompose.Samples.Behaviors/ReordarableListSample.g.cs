...
namespace UnityCompose.Samples.Behaviors
{
    internal partial class ReordarableListSample
    {
        ...
        {
            if (CurrentComposer.BeginComposeGroup(-1530013095, true))
                return;
            try
            {
                Box(horizontalAlignment: Alignment.Horizontal.Center, verticalAlignment: Alignment.Vertical.Center, modifier: Modifier, content: CurrentComposer.HasRememberedValue<bool, UnityCompose.ComposableContent>(-888905530, true) ? CurrentComposer.RememberedValue<bool, UnityCompose.ComposableContent>() : CurrentComposer.WriteComposableLambda<bool, UnityCompose.ComposableContent>(() =>
                {
                    Column(horizontalAlignment: Alignment.Horizontal.Center, modifier: Modifier.Name("reordarable-list-sample").Padding(top: 100).FillMaxHeight().Width(800), content: CurrentComposer.HasRememberedValue<bool, UnityCompose.ComposableContent>(2025003104, true) ? CurrentComposer.RememberedValue<bool, UnityCompose.ComposableContent>() : CurrentComposer.WriteComposableLambda<bool, UnityCompose.ComposableContent>(() =>
                    {
            ...
            {
                CurrentComposer.EndComposeGroup(CurrentComposer.HasRememberedValue<bool, Action>(-1529913095, true) ? CurrentComposer.RememberedValue<bool, Action>() : CurrentComposer.WriteComposableLambda<bool, Action>(() => __Layout()));
            }
        }
        ...
        private static void __Item(int state, Action onMoveUpClick, Action onMoveDownClick, Action onRemoveClick)
        {
            ...
            if (CurrentComposer.BeginComposeGroup(-1524142510, (__state, __onMoveUpClick, __onMoveDownClick, __onRemoveClick)))
                return;
            try
            {
                Row(verticalAlignment: Alignment.Vertical.Center, modifier: Modifier.Name("item-row").Background(Color.cyan).FillMaxWidth().Padding(all: 4).Border(radius: 12).Margin(vertical: 4).Name(state.ToString()), content: CurrentComposer.HasRememberedValue<ValueTuple<int, System.Action, System.Action, System.Action>, UnityCompose.ComposableContent>(-1365133680, (state, onMoveUpClick, onMoveDownClick, onRemoveClick)) ? CurrentComposer.RememberedValue<ValueTuple<int, System.Action, System.Action, System.Action>, UnityCompose.ComposableContent>() : CurrentComposer.WriteComposableLambda<ValueTuple<int, System.Action, System.Action, System.Action>, UnityCompose.ComposableContent>(() =>
                {
                    Text(text: $"Item no. {state}", color: Color.black, fontSize: 40, modifier: Modifier.Name("item-name-label").Weight(1).Margin(left: 32));
                    Column(content: CurrentComposer.HasRememberedValue<ValueTuple<System.Action, System.Action>, UnityCompose.ComposableContent>(-2029303902, (onMoveUpClick, onMoveDownClick)) ? CurrentComposer.RememberedValue<ValueTuple<System.Action, System.Action>, UnityCompose.ComposableContent>() : CurrentComposer.WriteComposableLambda<ValueTuple<System.Action, System.Action>, UnityCompose.ComposableContent>(() =>
                    {
