...
namespace UnityCompose.Samples.Behaviors
{
    internal partial class ReordarableListSample
    {
        ...
        private static void __Item(int state, Action onMoveUpClick, Action onMoveDownClick, Action onRemoveClick)
        {
            ...
            var __composer = CurrentComposer;
            __composer.StartRestartGroup(881946581);
            var __isRestarted = __composer.IsRestarted();
            ...
            __composer.EndRestartGroup(881946581, __isRestarted)?.UpdateScope(() => __Item(__state, __onMoveUpClick, __onMoveDownClick, __onRemoveClick));
        }
    }
}