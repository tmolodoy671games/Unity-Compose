            ...
            try
            {
                Box(alignHorizontally: Align.Center, alignVertically: Justify.Center, style: Modifier, content: RememberComposable<global::System.Action>(null, () =>
                {
                    Column(alignHorizontally: Align.Center, style: Modifier.Name("reordarable-list-sample").PaddingTop(100).Height(100.Percent()).Width(800), content: RememberComposable<global::System.Action>(null, () =>
                    {
                        ...
                        Label(text: "Add Item", textColor: Color.white, fontSize: 40, style: Modifier.Name("add-item-button").AlignSelf(Align.FlexEnd).Background(Color.blue).Padding(32, 16).BorderRadius(16).OnClick(Remember<global::System.Action>(items, () =>
                        {
            ...
            try
            {
                Row(alignVertically: Align.Center, style: Modifier.Name("item-row").Background(Color.cyan).Width(100.Percent()).Padding(4).BorderRadius(12).MarginVertical(4).Name(state.ToString()), content: RememberComposable<global::System.Action>((state, onMoveUpClick, onMoveDownClick, onRemoveClick), () =>
                {
                    ...
                    Column(content: RememberComposable<global::System.Action>((onMoveUpClick, onMoveDownClick), () =>
                    {
                        ...
                        Label(text: "↓", textColor: Color.white, fontSize: 40, fontStyle: FontStyle.Bold, align: TextAnchor.MiddleCenter, style: Modifier.Name("down-arrow-button").Background(Color.green).Padding(6, 4).BorderRadius(16).OnClick(onMoveDownClick));
                    }));
                    Label(text: "X", textColor: Color.white, fontSize: 40, fontStyle: FontStyle.Bold, align: TextAnchor.MiddleCenter, style: Modifier.Name("remove-button").Background(Color.red).Padding(16, 4).BorderRadius(16).OnClick(onRemoveClick));
                }));
            }
            finally
            {
