    ...
    internal partial class OnGloballyPositioned2Sample
    {
        ...
        private static void __Tab(bool selected, ComposableContent content, IModifier? modifier = null, global::UnityCompose.Composer __composer = null !, int __changed = -1)
        {
            ...
            if (__isCreated || __isRestarted || __dirty != 0b_01_01_01)
            {
                ...
                __Box(modifier: modifier.OrEmpty().Background(Color.grey).Padding(vertical: 8.Dp(), horizontal: __AnimateFloatAsState(selected ? 160 : 20, animationSpec: animationSpec, __composer: __composer, __changed: 0b_00_00).Value.Dp()).Margin(horizontal: 2.Dp()).Clip(RoundedCornerShape(16.Dp())).Scale(__AnimateFloatAsState(selected ? 0.8f : 1, __composer: __composer, __changed: 0b_01_00).Value), content: (!__composer.BuildChanged().Changed().ChangedAsFlag((__dirty & 0b_00_11_00) == 0b_00_10_00).Get() ? __composer.RememberedValue<global::UnityCompose.ComposableContent>() : __composer.UpdateRememberedValue<global::UnityCompose.ComposableContent>(() =>
                {
