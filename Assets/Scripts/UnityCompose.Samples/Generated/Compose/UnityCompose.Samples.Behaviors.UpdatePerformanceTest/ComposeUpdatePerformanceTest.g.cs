    ...
    internal partial class ComposeUpdatePerformanceTest
    {
        ...
        private static void __Item(int currentI, Vector2 parentSize, global::UnityCompose.Composer __composer = null !, int __changed = -1)
        {
            ...
            if (__isCreated || __isRestarted || __dirty != 0b_01_01)
            {
                ...
                __LaunchedEffect(key: parentSize, coroutine: (!__composer.BuildChanged().Changed<global::UnityEngine.Vector2>(parentSize!).Changed<global::UnityCompose.IMutableState<global::UnityEngine.Vector2>>(position!).Get() ? __composer.RememberedValue<global::System.Func<global::System.Collections.IEnumerator>>() : __composer.UpdateRememberedValue<global::System.Func<global::System.Collections.IEnumerator>>(() => PerformanceUtils.MoveRandomlyCoroutine(parentSize: () => parentSize, it => position.Value = it))), __composer: __composer, __changed: ((__dirty & 0b_11_00) >> 2));
                var baseModifier = (!__composer.Changed<int>(currentI!) ? __composer.RememberedValue<global::UnityCompose.IModifier>() : __composer.UpdateRememberedValue<global::UnityCompose.IModifier>(Modifier.Size(50.Px()).Background(PerformanceUtils.Colors[currentI % PerformanceUtils.Colors.Length]).Float()));
